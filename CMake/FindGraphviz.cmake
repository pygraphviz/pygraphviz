...
# References:
#     https://raw.githubusercontent.com/KDAB/KDStateMachineEditor/master/cmake/FindGraphviz.cmake
...
if(_GRAPHVIZ_ROOT)
  set(_GRAPHVIZ_INCLUDE_PREFIX ${_GRAPHVIZ_ROOT}/include)
  set(_GRAPHVIZ_LIBRARY_PREFIX ${_GRAPHVIZ_ROOT}/lib)
  set(_GRAPHVIZ_FIND_OPTS NO_DEFAULT_PATH)
else()
  set(_GRAPHVIZ_FIND_OPTS "")
endif()

if(GRAPHVIZ_INCLUDE_PREFIX)
  set(_GRAPHVIZ_INCLUDE_PREFIX ${GRAPHVIZ_INCLUDE_PREFIX})
endif()
if(GRAPHVIZ_LIBRARY_PREFIX)
  set(_GRAPHVIZ_LIBRARY_PREFIX ${GRAPHVIZ_LIBRARY_PREFIX})
endif()

find_path(GRAPHVIZ_INCLUDE_DIR NAMES graphviz/graph.h graphviz/cgraph.h
  HINTS ${_GRAPHVIZ_INCLUDE_PREFIX}
  ${_GRAPHVIZ_FIND_OPTS})
...
find_library(GRAPHVIZ_CDT_LIBRARY NAMES cdt
  HINTS ${_GRAPHVIZ_LIBRARY_PREFIX} PATH_SUFFIXES ${GRAPHVIZ_LIB_PATH_SUFFIX}
  ${_GRAPHVIZ_FIND_OPTS})
...
check_include_files("${GRAPHVIZ_INCLUDE_DIR}/graphviz/graphviz_version.h" HAVE_GRAPHVIZ_VERSION_H)
...
if(GRAPHVIZ_FOUND)
  if(NOT WIN32)
    ...
    if(COMPILE_RESULT AND RUN_RESULT EQUAL 1 AND NOT CMAKE_CROSSCOMPILING)
      ...
      if(NOT CMAKE_CROSSCOMPILING)
        ...
        message(STATUS "GV COMPILE_RESULT = ${COMPILE_RESULT}")
        message(STATUS "GV RUN_RESULT = ${RUN_RESULT}")
        message(WARNING "Unable to compile or run the graphviz version detection program.")
      endif()
    endif()
  elseif(WIN32)
  ...
  if(NOT GRAPHVIZ_FIND_QUIETLY)
    message(STATUS "Found Graphviz:
      GRAPHVIZ_INCLUDE_DIR = ${GRAPHVIZ_INCLUDE_DIR}

      GRAPHVIZ_CDT_LIBRARY = ${GRAPHVIZ_CDT_LIBRARY}
      GRAPHVIZ_GVC_LIBRARY = ${GRAPHVIZ_GVC_LIBRARY}
      GRAPHVIZ_CGRAPH_LIBRARY = ${GRAPHVIZ_CGRAPH_LIBRARY}
      GRAPHVIZ_GRAPH_LIBRARY = ${GRAPHVIZ_GRAPH_LIBRARY}
      GRAPHVIZ_PATHPLAN_LIBRARY = ${GRAPHVIZ_PATHPLAN_LIBRARY}
    ")
  endif()
else()
  if(NOT GRAPHVIZ_FIND_QUIETLY)
    message(WARNING "Could NOT find Graphivz:
      GRAPHVIZ_INCLUDE_DIR = ${GRAPHVIZ_INCLUDE_DIR}
