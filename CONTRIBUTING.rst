...
To measure the test coverage, run::
  ...
  $ pytest --cov=pygraphviz --pyargs pygraphviz
...
SWIG is a listed build dependency and will automatically be installed at build
time.
The SWIG-generated C code (``graphviz_wrap.c``) is automatically generated by
SWIG at build-time - there is no need to invoke SWIG explicitly.
