...
SWIGINTERN PyObject *_wrap_gvContextWithBuiltins(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GVC_t *result = 0 ;
  
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "gvContextWithBuiltins", 0, 0, 0)) SWIG_fail;
  result = (GVC_t *)gvContextWithBuiltins();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_GVC_t, 0 |  0 );
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "gvContextWithBuiltins", _wrap_gvContextWithBuiltins, METH_NOARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
